...
export function PeerlistIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12 1c-3.3 0-5.9.03-7.77.35-1.9.32-3.25 1-3.9 2.5C.03 5.02 0 6.85 0 9v6c0 2.15.03 3.98.33 5.15.65 1.5 2 2.18 3.9 2.5C6.1 22.97 8.7 23 12 23s5.9-.03 7.77-.35c1.9-.32 3.25-1 3.9-2.5.3-1.17.33-3 .33-5.15V9c0-2.15-.03-3.98-.33-5.15-.65-1.5-2-2.18-3.9-2.5C17.9 1.03 15.3 1 12 1zm-1.5 5h3.25a4.75 4.75 0 0 1 0 9.5H12v2.5H9V7.5c0-.83.67-1.5 1.5-1.5zm1.5 3v3.5h1.75a1.75 1.75 0 0 0 0-3.5H12z" />
    </svg>
  );
}
